class ApprovalSiteVisitListPage {
  // ---- Navigasi ----

  visit() {
    cy.visit('/finalisasi/site-visit');
  ...
  verifikasiHalamanList() {
    ...
    // "List Request" unik di konten utama — tidak ada di sidebar
  ...
  // Di halaman Approval, kolom Actions hanya memiliki satu tombol (eye icon).
...
export default new ApprovalSiteVisitListPage();
